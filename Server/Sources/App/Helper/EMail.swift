...
///////////////////////////////////////////////////////////////
// The HTML texts can be found in ./Resources/EMailTemplates //
///////////////////////////////////////////////////////////////
...
/// Send an email to the user where he can reset his/her password
///
/// - Parameters:
///   - email: The users email address
///   - username: The users username
///   - link: The link where the user can reset his/her password
///   - drop: Droplet in order to get the mail API key and send the request
/// - Returns: true on success, false when something goes wrong
